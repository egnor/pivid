# Based on: https://conan.io/center/recipes/ffmpeg?version=5.1.3
# Modified for Raspberry Pi support (using patched source) as run here:
# https://github.com/jc-kynesim/rpi-ffmpeg/blob/pi/5.1.3/rpi_22/pi-util/conf_native.sh
#
# All pivid-specific changes are controlled by the "for_pivid" option.
# Also see conandata.yml and the Pi-specific patch file in this directory.
    ...
    def generate(self):
        ...
        if self.options.for_pivid:
            args.extend([
                ...
                "--disable-mmal",   # New hotness only, skip this old stuff
                "--enable-libdrm",
                "--extra-version=pivid",
                "--enable-libudev",
                "--enable-libv4l2",
